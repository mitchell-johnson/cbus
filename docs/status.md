...
| SAL applications | Implemented | Lighting, AIRCON/HVAC, Audio, Security, Measurement, Telephony, Network Management locate, learn mode, clock, enable control, temperature broadcast, and status request |

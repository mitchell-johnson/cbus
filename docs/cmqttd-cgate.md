...
`cbus-cgate::capability_matrix` (pinned by `rust/cbus-cgate/tests/capability_matrix.rs`): 226
physical, 196 local/session, 7 fail-closed 502, and 2 obsolete 400 over the
...
persistence, configured-project boundary, six retained 502 operations, and
the absence of administrative PCI traffic.

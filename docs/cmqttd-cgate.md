...
checksummed `RECALL 0xFB 9`; decoding stops at the first NUL. The application
read sends one OEM selector STORE for address 16 (`41 10 00`) and one
parameter-1 RECALL of two bytes. WidgetGroups is one checksummed `RECALL 0xFA

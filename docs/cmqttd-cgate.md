...
physical, 49 local/session, 346 fail-closed 502, and 1 obsolete 400 over the
...
`/p/42` interface unit is deleted. The exact one-hop PINGU request is retained separately as a

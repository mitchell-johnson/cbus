...
- `rust/testdata/vectors/` contains JSONL cases for checksums, frame encode/decode, ramp rates, MQTT topics, Home Assistant discovery, and strict selected-serial plan interchange.

...
UNRAVEL uses a complete known-serial plan with independently empty targets,
exact-once selected-serial writes, per-target verification, and a final full

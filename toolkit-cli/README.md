...
//PROJECT/254/p/4` projects the admitted RELAY4, generic, KEYE1/2/3, DIMDN8 and
RELDN12 read-only C-Gate XML shapes without manual cache transcription. KEYE
...
12-channel RELDN12 interaction limits. `cgate --host HOST database-csv
...
BOM-free output. The current core/CLI set passes 61 tests, both host Windows

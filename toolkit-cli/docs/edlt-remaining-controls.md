...
| **Physical factory reset, template dialog, live status refresh** | Remaining operational workflows | Factory-default source preparation has [separate bounded acceptance](edlt-reset-factory.md); this does not establish physical FactoryReset. Complete TemplatesDialog and UpdateUnitStatus behavior remain outside these global helpers. |

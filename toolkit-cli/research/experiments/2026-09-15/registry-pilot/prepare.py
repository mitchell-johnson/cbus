...
BASE = HERE.parent
PREFIX = 'registry-admission-a16df02361e14a1c'
ROOT_NAME = 'CBusCliCondition_a16df02361e14a1c9329771a063bbd4e'
...
def main():
    ...
    contract={'format':'toolkit-update-registry-admission-contract-v1','original_executed':False,
              ...
              'expected_clr_bits':32,'vendor':vendor,'type_tokens':type_tokens,'method_pins':method_records,
              ...
              'execution_release_required':'root-reviewed-registry-twelve-v1'}

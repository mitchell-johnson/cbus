...
class Guards(unittest.TestCase):
    ...
    def test_original_assembly_method_and_scope_correlation(self):
        ...
        rows[0]['registry_provider']={'source_memberref':contract['registry_getvalue_memberref'],'declaring_type':'Microsoft.Win32.Registry',
        ...
        for name,path,digest in [('SE.DAD.SESU.Common',guest+'se.dad.sesu.common.dll',contract['vendor']['SE.DAD.SESU.Common']['sha256']),
                                 ('Microsoft.Win32.Registry',guest+'microsoft.win32.registry.dll',contract['vendor']['Microsoft.Win32.Registry']['sha256']),
        ...
        for mutate in [lambda r:r[0]['assemblies'][0].update(sha256='b'*64),
                       ...
                       lambda r:r[0]['registry_provider'].update(same_original_and_witness=False),

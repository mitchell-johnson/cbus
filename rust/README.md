...
| `cbus-cgate`     | lib  | command-complete in-memory C-Gate 3.4 model: all 224 public manual headings and all 268 bytecode-registered subcommands (431 unique paths), with native-shaped core project/database/network/PP behavior and deterministic stateful application/private-family emulation; see [`../toolkit-cli/docs/rust-cgate-command-coverage.md`](../toolkit-cli/docs/rust-cgate-command-coverage.md) |
